...
export const SpotifyLink: React.FunctionComponent<SpotifyLinkProps> = ({
  ...
  return (
    <a
      ...
      className="inline-flex items-center p-2 px-3 space-x-2 text-sm text-white transition duration-500 ease-in-out rounded-md bg-spotifyGreen hover:bg-opacity-70"
    >
      <span>Spotify</span>
      <span>
        <svg
